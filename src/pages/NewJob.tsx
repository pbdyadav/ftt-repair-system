  ...
  const handleSubmit = async (jobData: Partial<Job>) => {
    try {
      ...
      const newJob: Job = {
        ...
        status: 'Pending',
        serviceType: jobData.serviceType || 'Paid',
        warrantyStartDate: jobData.warrantyStartDate || '',
        warrantyEndDate: jobData.warrantyEndDate || '',
        amcStartDate: jobData.amcStartDate || '',
        amcEndDate: jobData.amcEndDate || '',
        serviceItems: jobData.serviceItems || [],
        createdAt: new Date(),
        updatedAt: new Date(),
        completedAt: null,
      };
