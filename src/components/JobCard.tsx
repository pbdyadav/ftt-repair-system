...
import { generateJobCardPDF } from "@/utils/generateJobCardPDF";
import { openWhatsAppTo } from "@/lib/whatsapp";

import {
  generateJobSheetImageAndUpload,
} from "@/lib/jobUtils";
...
Job Sheet No: ${job.jobSheetNumber}
